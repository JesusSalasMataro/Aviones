	...
	public void run() {
		...
		if( (EspacioAereo != null) && (Lienzo != null) ) {
			...
			while( !bParar ) {
				...
				// El procedimiento 'mantenimiento' elimina del espacio aéreo los aviones en estado
				// inactivo y los que se han salido de los límites del espacio aéreo, devuelve el
				// número de aviones eliminados
				if( EspacioAereo.mantenimiento(PanelesInfo) > 0 ) {
					// Comprovamos si quedan aviones y en ese caso establecemos el nuevo avión activo
