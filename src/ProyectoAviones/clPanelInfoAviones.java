...
public class clPanelInfoAviones extends JPanel {
	...
	public void CrearPanel( int iPosPanel, String strMatricula, String strFabricante,
		...
		lblEtiqueta[LABEL_NUMAVION_MATRICULA][iPosPanel].setText(" Avión " + Integer.toString(iPosPanel+1) + "   Matrícula: " + strMatricula);
		...
		lblEtiqueta[LABEL_ALTURA_RUMBO][iPosPanel].setText(" Altura: 0 m   Rumbo: 0º");
	...
	// Se encarga de resaltar en rojo el panel correspondiente al índice iPosPanel
	...
	// Actualiza la información de los paneles de datos de los aviones
	...
	// Modifica un campo concreto del panel de información de un avión
	// iNumEtiqueta:  indica el campo a modificar
	// aviAvion:      el avión al cual se le va a modificar la información
	// iPosPanel:     índice del panel que pertenece a ese avión
	// iAvionActivo:  avión activo en ese momento     
		...
		switch( iNumEtiqueta ) {
			...
			case LABEL_ALTURA_RUMBO:
				lblEtiqueta[LABEL_ALTURA_RUMBO][iPosPanel].setText(" Altura: " + Integer.toString(aviAvion.getAltitud()) + " m   " + 
					"Rumbo: " + Integer.toString(aviAvion.getRumbo()) + "º");
				break;
	...
	// Vacía un cuadro de información de un avión que haya sido eliminado
